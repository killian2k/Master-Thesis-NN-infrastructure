...
def main():
    ...
    #                     help='filname of the yaml file to use to download the data in the folder scenarios/configs_initial_tests')
    ...
    # with open(f'scenarios/configs_initial_tests/{args.yaml_file_datasets}.yaml') as f:
